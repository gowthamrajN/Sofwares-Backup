...
{ 
  ...
  addinglong=0;
  Subractlong=0;
  if(tmr_20s == 0 || currentTime - tmr_20s >= 120000)
  { 
    flowCal();
    EepromWrite();
    print2Serial();
  ...
  if(tmr_ping == 0 || currentTime - tmr_ping >= 60000)        //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min //600000 for 10mins
  {
     Serial1.begin(2400);
     delay(15000);
    falconClient(jsn);
