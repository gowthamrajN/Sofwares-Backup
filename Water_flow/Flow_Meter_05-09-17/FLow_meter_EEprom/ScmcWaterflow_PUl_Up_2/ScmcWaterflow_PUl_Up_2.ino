...
{  
  ...
  if(tmr_ping == 0 || currentTime - tmr_ping >= 600000)        //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min //600000 for 10mins
  {
    falconClient(jsn);
    tmr_ping = millis();
  }
...
//  jsn = jsn + devID + "&slotreading=" + units_str + "&meterreading=" + lit_total + "&warningcode=01\"";
  ...
  jsn = jsn + "&analog0=" + lit_total + "&analog1="+ units_str +"&analog2=0&analog3=0&analog4=0&analog5=0&digital0=0&digital1=0&digital2=0&digital3=0&digital4=0&digital5=0&serial0=A&serial1=0&serial2=0&serial3=0&latitude=+1130.6059&longitude=+7806.0677&keypad=0&customstring=SCMC%20falcon%20message1\"";
