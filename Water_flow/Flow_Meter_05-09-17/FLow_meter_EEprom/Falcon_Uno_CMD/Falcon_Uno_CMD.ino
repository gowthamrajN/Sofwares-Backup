...
void loop() 
{
  ...
  jsn = jsn + devID + "&analog0=" + val+ "&analog1=5&analog2=1&analog3=2&analog4=3&analog5=4&digital0=0&digital1=1&digital2=0&digital3=1&digital4=0&digital5=1&serial0=A&serial1=1&serial2=a&serial3=-&latitude=+1130.6059&longitude=+7806.0677&keypad=0&customstring=salieabs%20falcon%20message1\"";
  Serial.print("Value= ");
  Serial.println(val);
