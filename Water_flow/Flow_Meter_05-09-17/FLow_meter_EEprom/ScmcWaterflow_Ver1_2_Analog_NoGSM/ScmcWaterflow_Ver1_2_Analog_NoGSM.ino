...
void setup()
{
  ...
  pinMode(A0, INPUT);          //Reset all values
  pinMode(A2,INPUT);          // Subracting 10
  digitalWrite(A2, INPUT_PULLUP); 
  pinMode(A1,INPUT);          //Adding 10
...
void flowCal()
{
  ...
  jsn = "AT+HTTPPARA=\"URL\",\"http://track.salieabs.com/json/AddTrackDetails.aspx?deviceid=2";
