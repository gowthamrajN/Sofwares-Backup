...
unsigned long CurrentTime=0; // Millis Calculation 
...
void loop() 
{
  ...
  showLCD(Sum,units);
  CurrentTime=millis();
  if(CurrentTime-PreviousTime>=60000)             //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min
  {
    falconClient(jsn);
    PreviousTime=millis();
  }
