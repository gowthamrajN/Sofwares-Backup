...
{  
  ...
  if(tmr_ping == 0 || currentTime - tmr_ping >= 7200000)        //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min //600000 for 10mins
  {
    falconClient(jsn);
    tmr_ping = millis();
  }
...
//  jsn = jsn + devID + "&slotreading=" + units_str + "&meterreading=" + lit_total + "&warningcode=01\"";
  ...
  jsn = "AT+HTTPPARA=\"URL\",\"http://track.salieabs.com/json/AddTrackDetails.aspx?deviceid=4";
