...
{  
  ...
  if(tmr_ping == 0 || currentTime - tmr_ping >= 30000)        //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min //600000 for 10mins
  {
    /*Serial1.begin(2400);
    delay(10000);*/
    falconClient(jsn);
...
void flowCal()
{
  ...
  //  jsn = jsn + devID + "&slotreading=" + units_str + "&meterreading=" + lit_total + "&warningcode=Warning\"";

  //Uncomment the following two lines to send to track.salieabs.com
  jsn = "AT+HTTPPARA=\"URL\",\"http://track.salieabs.com/json/AddTrackDetails.aspx?deviceid=12";
  jsn = jsn + "&analog0=" + lit_total + "&analog1="+ units_str +"&analog2="+ Warning +"&analog3=0&analog4=0&analog5=0&digital0=0&digital1=0&digital2=0&digital3=0&digital4=0&digital5=0&serial0=0&serial1=0&serial2=0&serial3=0&latitude=+1130.6059&longitude=+7806.0677&keypad=0&customstring=SCMC\"";
...
void powerCheck()
{
  ...
  else if ((640<=Voltage) && (Voltage<=671))
  {
    Warning="102";
    //Serial.println("Adapter + Battery(Full)");
  }
    else if (Voltage<653 && Voltage>100)
  {
    Warning="103";
