...
unsigned long devID = 1002150001;     //CC - Two Digit City Code,ZZ - Two Digit Zone Code,WW - Two Digit Ward Code,DDDD - 4 digit device ID
...
{ 
  ...
  if(tmr_ping == 0 || currentTime - tmr_ping >= 3600000)        //43200000 for half day  //86400000 for one day //21600000 for 6hrs  //3600000 for 1hr  //10800000 for 3 hors//7200000 for 2hrs//60000 for 1 min //600000 for 10mins
  {
     Serial1.begin(2400);
     delay(15000);
    falconClient(jsn);
