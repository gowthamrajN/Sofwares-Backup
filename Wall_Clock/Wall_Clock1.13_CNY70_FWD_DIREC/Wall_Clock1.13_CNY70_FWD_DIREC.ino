...
void processSerial(bool source)
{
  ...
  if((destHours >= 1 && destMins >= 30) || (destHours == 1 && destMins >= 30))
  {
    difference = ((destHours - 1) * 360) + ((destMins - 30) * 6);
  }
...
//    Before130();
//  }
//  else if((destHours>1)&&(destMins>=30))
//   {
//    difference  =((destHours - 1) * 360) + (abs(destMins - 30) * 6);
//   }
//  else if((destHours==1)&&(destMins<=29))
//  {
//    difference = ((destHours - 0) * 360) + ((destMins - 0) * 6);
//  }
  
  difference_Seconds =destSec-1;        // SECOND HAND PULSE DIFFERENCE
...
void OneSecond_Ticking()
{
  ...
  if (scounter >= 10)
  {
    ...
    else
    {
      ...
      * ONE HOUR 360 PULSES ,WE SETTING TIME TO 1:30 .SO 360+180=540 PULSE ,HERE WE GIVE TWO PULSE SO DIVIDE BY 2 ,270 PULSE 
      */
